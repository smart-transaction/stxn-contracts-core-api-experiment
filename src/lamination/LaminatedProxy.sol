...
contract LaminatedProxy is LaminatedStorage, ReentrancyGuard {
    ...
    /// @param callsToMake The array of CallObject containing information about functions to execute.
    /// @return returnValue The return value from the executed function call.
    function execute(CallObject[] calldata callsToMake) external onlyOwner nonReentrant returns (bytes memory) {
    ...
    /// @param callObjs The array of CallObject containing information about the function call to defer.
